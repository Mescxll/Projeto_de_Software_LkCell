...
import { useGerenciarCliente } from "@/hooks/cliente/useGerenciarCliente";
import {
  ArrowLeft,
  UserPlus,
  Search,
    ...
    <>
      ...
      <main className="p-8 px-55 min-h-screen bg-[#f4f6fb]">
        ...
        <div className="relative w-full max-w-xl mb-6">
          ...
          <input
            type="text"
            placeholder="Buscar por nome, ID, email, CPF ou CNPJ, Física ou Jurídica..."
