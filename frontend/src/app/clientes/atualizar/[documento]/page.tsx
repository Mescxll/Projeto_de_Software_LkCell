...
import { ArrowLeft, FileText, User, Phone, MapPin, AlertTriangle, Save, CheckCircle } from "lucide-react";
...
export default function AtualizarCliente() {
  ...
  const handleSalvar = async () => {
    ...
    if (res.ok) setModal(true);
    else setModalErro(true);
  };
        ...
        <main className="min-h-screen bg-[#f4f6fb] p-8">
          ...
          <div className="flex flex-col items-center">
            <div className="w-full max-w-xl">
              {/* Título */}
              <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-800">Atualizar Cliente</h1>
                <p className="text-sm text-gray-400 mt-1">Edite as informações do cliente</p>
              </div>
            </div>
            {/* Formulário */}
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input type="text" value={documento as string} disabled
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input type="text" name="nome" value={form.nome} onChange={handleChange}
                  placeholder="Digite o nome completo" className={inputIconClass} />
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <input type="text" name="uf" value={form.uf} onChange={handleChange}
                    placeholder="UF" maxLength={2} className={`${inputClass} uppercase`} />
                </div>
                <input type="text" name="cep" value={form.cep} onChange={handleChange}
                  placeholder="CEP (00000-000)" className={inputClass} />
              </div>
            </div>
      ...
      {modal && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm text-center">
            ...
            <p className="text-xs text-gray-400 mb-6">Cliente atualizado com sucesso.</p>
            <button
        ...
        {modalErro && (
          <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm text-center">
              ...
              <p className="text-xs text-gray-400 mb-6">Preencha todos os campos obrigatórios: nome e telefone.</p>
              <button
