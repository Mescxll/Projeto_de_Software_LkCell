// app/catalogo/categoria/atualizar/[id]/page.jsx
"use client";
import { useRouter, useParams } from "next/navigation";
import Navbar from "@/components/Navbar";
import { useAtualizarCategoria } from "@/hooks/catalogo/categoria/useAtualizarCategoria";
import {
  ArrowLeft,
  Folder,
  Loader2,
    ...
    return (
      <>
        ...
        <main className="min-h-screen bg-[#f4f6fb] flex items-center justify-center">
          <p className="text-gray-400 text-sm">Carregando categoria...</p>
        </main>
      </>
    );
  }
      ...
      <>
        ...
        <main className="min-h-screen bg-[#f4f6fb] flex items-center justify-center">
          <div className="text-center">
            ...
            <button
              onClick={() => router.push("/catalogo/categoria/gerenciar")}
