...
import { User, Calendar, UserPlus, CheckCircle, AlertTriangle, ArrowLeft } from "lucide-react";
        ...
        <div className="flex flex-col items-center">
          <div className="w-full max-w-lg">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
              ...
              {/* Título */}
              <div className="mb-6">
                <h1 className="text-xl font-bold text-gray-800">Cadastro de Funcionário</h1>
                <p className="text-xs text-gray-400 mt-1">Preencha as informações do novo funcionário</p>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input type="date" name="data_nascimento"
                    value={form.data_nascimento} onChange={handleChange} className={inputIconClass} />
                </div>
              </div>
      ...
      {modal === "sucesso" && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm text-center">
            ...
            <h2 className="text-lg font-bold text-gray-800 mb-1">Funcionário cadastrado com sucesso!</h2>
            <p className="text-sm text-blue-500 font-medium mb-1">{form.nome}</p>
            <p className="text-xs text-gray-400 mb-6">O funcionário foi adicionado ao sistema LKCell</p>
            <button onClick={() => router.push("/funcionarios/gerenciar")}
              className="w-full py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-semibold text-sm transition-all mb-3">
              Fechar
            </button>
            <button onClick={() => { setModal(null); setForm({ nome: "", data_nascimento: "" }); }}
      ...
      {modal === "erro" && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm text-center">
            ...
            <h2 className="text-lg font-bold text-gray-800 mb-1">Erro ao cadastrar funcionário</h2>
